...
public class AdminUserAccount extends javax.swing.JPanel {
    ...
    private void backAction() {
        ...
        manageUserAccountsJPanel.refreshTable();
        CardLayout layout = (CardLayout) CardSequencePanel.getLayout();
    ...
    public void refreshTable() {
            ...
            //fill selected user account details to display
            Object[] row = new Object[5];
            row[0] = selecteduseraccount;
            row[1] = selecteduseraccount.getPassword(); //password
            row[2] = selecteduseraccount.getPersonId(); //Full Name
            row[3] = selecteduseraccount.getStatus();          //Status
