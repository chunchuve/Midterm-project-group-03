...
// Create Admins to manage the univ
        ...
        // Set courses offer
        CourseOffer co1 = courseSchedule1.newCourseOffer(c1.getCourseNumber());
        CourseOffer co2 = courseSchedule1.newCourseOffer(c5.getCourseNumber());
        CourseOffer co3 = courseSchedule1.newCourseOffer(c6.getCourseNumber());
        CourseOffer co4 = courseSchedule2.newCourseOffer(c2.getCourseNumber());
        CourseOffer co5 = courseSchedule2.newCourseOffer(c6.getCourseNumber());
        CourseOffer co6 = courseSchedule2.newCourseOffer(c5.getCourseNumber());
        CourseOffer co7 = courseSchedule3.newCourseOffer(c3.getCourseNumber());
        CourseOffer co8 = courseSchedule3.newCourseOffer(c7.getCourseNumber());
        CourseOffer co9 = courseSchedule3.newCourseOffer(c4.getCourseNumber());
        CourseOffer co10 = courseSchedule4.newCourseOffer(c7.getCourseNumber());
        CourseOffer co11 = courseSchedule4.newCourseOffer(c4.getCourseNumber());
        ...
        co5.AssignAsTeacher(facultyprofile1);
        co6.AssignAsTeacher(facultyprofile0);
        co7.AssignAsTeacher(facultyprofile1);
        co8.AssignAsTeacher(facultyprofile1);
        co9.AssignAsTeacher(facultyprofile0);
        co10.AssignAsTeacher(facultyprofile1);
        co11.AssignAsTeacher(facultyprofile1);
        ...
        co8.generatSeats(40);
        co9.generatSeats(3);
        co10.generatSeats(30);
        co11.generatSeats(20);
